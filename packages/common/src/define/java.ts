...
const ClassesString = {
  ...
  LocaleList: 'android.os.LocaleList',
  ...
  SharedPreferencesImpl$EditorImpl: 'android.app.SharedPreferencesImpl$EditorImpl',
  ...
  HttpsURLConnectionImpl: 'com.android.okhttp.internal.huc.HttpsURLConnectionImpl',
  ...
  HeapByteBuffer: 'java.nio.HeapByteBuffer',
  ...
  MediaSession: 'android.media.session.MediaSession',
